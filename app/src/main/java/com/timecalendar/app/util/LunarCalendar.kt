...
object LunarCalendar {
    ...
    // Each entry encodes: leap month (bits 0-3), month days (bits 4-15), leap month days (bit 16)
    private val LUNAR_INFO = longArrayOf(
        ...
        0x06566, 0x0d4a0, 0x0ea50, 0x16a95, 0x05ad0, 0x02b60, 0x186e3, 0x092e0, 0x1c8d7, 0x0c950, // 1931-1940
        ...
        0x0c960, 0x0d954, 0x0d4a0, 0x0ab50, 0x07552, 0x056a0, 0x0abb7, 0x025d0, 0x092d0, 0x0cab5, // 2001-2010
        ...
        0x0b5a0, 0x056d0, 0x055b2, 0x049b0, 0x0a577, 0x0a4b0, 0x0aa50, 0x1b255, 0x06d20, 0x0ada0  // 2041-2049
    )
